...
import "./SecondTab_01list.css"

function SecondTab_01list() {
    return (
        <div id ="test" style={{height:'100%',padding:'15px 5px 5px'}}>
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th style={{width:'0%',padding:'0px'}}><div>+</div></th>
								</tr>
							</thead>
						</table>
					</div>
						...
						<table>
							<tbody>
								<tr class="row100 body">
									...
									<td class="cell100 column2">cairoplacdsadasdsadas</td>
									<td colSpan='2' class="cell100 column3">PHM</td>
								</tr>
								...
								<tr class="row100 body">
									...
									<td class="cell100 column3">PHM</td>
								</tr>
...
export default SecondTab_01list;